export default [
  {
    title: "motion-tablesymmetric-move",
    description: "动效周期表-对称运动",
    tags: ["motion", "symmetric"],
  },
  {
    title: "puzzle-game",
    description: "拼图游戏",
    tags: ["image", "split", "puzzle", "game"],
  },
  {
    title: "split-image-with-css-variable",
    description: "用CSS变量分割图片",
    tags: ["image", "split"],
  },
  {
    title: "motion-tableoffset",
    description: "动效周期表-偏移",
    tags: ["motion", "orbit"],
  },
  {
    title: "motion-tableorbit",
    description: "动效周期表-轨道",
    tags: ["motion", "orbit"],
  },
  {
    title: "infinite-line-animation",
    description: "无限线条动画",
    tags: ["line", "infinite"],
  },
  {
    title: "firework-dialog",
    description: "烟花效果对话框",
    tags: ["dialog", "firework", "particle"],
  },
  {
    title: "spiral-tower",
    description: "螺旋塔",
    tags: ["3d", "staggered", "spiral"],
  },
  {
    title: "svg-filter-motion-blur",
    description: "SVG滤镜动态模糊",
    tags: ["filter", "motion blur"],
  },
  {
    title: "gradient-mask-divider",
    description: "渐变遮罩分割线",
    tags: ["gradient", "mask", "divider"],
  },
  {
    title: "3d-puzzle-animation",
    description: "3d拼图动画",
    tags: ["3d", "puzzle"],
  },
  {
    title: "svg-filter-gooey-menu",
    description: "SVG滤镜粘滞菜单",
    tags: ["filter", "gooey"],
  },
  {
    title: "svg-filter-glitch-button",
    description: "SVG滤镜故障按钮",
    tags: ["filter", "glitch"],
  },
  {
    title: "smoke",
    description: "烟雾",
    tags: ["smoke", "particle", "staggered"],
  },
  {
    title: "cube-wave",
    description: "3d方块波浪",
  ...
  {
    title: "3d-stair-loading",
    description: "3d阶梯加载",
    tags: ["3d", "staggered"],
  },
  {
    title: "matryoshka-tunnel",
    description: "套 娃 隧 道",
